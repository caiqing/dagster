...
@click.command(
    ...
    help='Update instance_profile.yaml to disable telemetry. Requires $DAGSTER_HOME to be set \
        Note: This will not modify DAGSTER_TELEMETRY_ENABLED env var \
        For more information, check out the docs at \
        https://docs.dagster.io/latest/install/telemetry/',
)
...
@click.command(
    ...
    help='Update instance_profile.yaml to enable telemetry. Requires $DAGSTER_HOME to be set \
        Note: This will not modify DAGSTER_TELEMETRY_ENABLED env var \
        For more information, check out the docs at \
        https://docs.dagster.io/latest/install/telemetry/',
)
